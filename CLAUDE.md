...
At the start of every session: read `docs/index.md` to orient, read `docs/todo-technical.md` and tick off anything completed. Read `docs/project-rules.md` before any design or architectural decision or bug fix. Read `docs/technical-tips.md` before any 3D asset, animation, or bone work. Read `docs/color-scheme.md` before any visual, UI, VFX, or material work.

...
On session start, read `.agents/AGENTS.md` and compare its **Project Rules** and **Session-Start Todo Behaviour** sections against the equivalent sections in this file.
